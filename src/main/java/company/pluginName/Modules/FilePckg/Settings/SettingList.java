...
public enum SettingList implements FileObjFieldsEnum<List<String>> {
	...
	COMMANDS_PROTECTIONBLOCKS_HIDE_ALIASES("Commands.Protection-blocks.Set-home.Aliases", Arrays.asList("h")),
	COMMANDS_PROTECTIONBLOCKS_SHOW_ALIASES("Commands.Protection-blocks.Set-home.Aliases", Arrays.asList("sw")),
