...
@PandaCommandAnnotation(id = "ban", pathName = "Ban", defaultName = "ban", defaultDescription = "Ban a player from your current protection", defaultUsage = "<username>", defaultAliases = "bn")
