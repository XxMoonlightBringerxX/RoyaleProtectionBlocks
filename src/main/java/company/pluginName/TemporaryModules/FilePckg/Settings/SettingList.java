...
public enum SettingList implements FileObjFieldsEnum<List<String>> {
	...
	COMMANDS_PROTECTIONBLOCKS_BLOCKS_REMOVE_ALIASES("Commands.Protection-blocks.Blocks.Remove.Aliases", Arrays.asList("r")),
	...
	COMMANDS_PROTECTIONBLOCKS_FILES_EXPORT_ALIASES("Commands.Protection-blocks.Files.Export.Aliases", Arrays.asList("e")),
	COMMANDS_PROTECTIONBLOCKS_FILES_IMPORT_ALIASES("Commands.Protection-blocks.Files.Import.Aliases", Arrays.asList("i")),
