...
@PandaCommandAnnotation(
		...
		pathName = "Private",
		defaultName = "private",
		defaultDescription = "Sets a protection to be only accessed by its members through the inventories")
@PandaCommandAnnotation.Customizable(
		...
		permission = true,
		usage = true)
public class PrivateSubCommand extends PandaSubCommand {

	public PrivateSubCommand() throws InstantiationException {
		super();
	}
				...
				try {
					RoyaleProtectionBlocksAPI.getInstance().getPlayerInteractionsService()
							.protectionTogglePublicAccessRequest(
									ProtectionTogglePublicAccessRequestInput.inst(pl, protection, false));
					MessageTemplate
