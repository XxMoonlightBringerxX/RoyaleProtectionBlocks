...
@PandaCommandAnnotation(
		...
		pathName = "View",
		defaultName = "view",
		defaultDescription = "Show the boundaries of all the protections for a certain amount of time",
		defaultAliases = "v")
...
public class ViewSubCommand extends PandaSubCommand {
	...
	public static final PandaBooleanField SETTINGS_PROTECTION_VIEW_SHOWOTHERPLAYERPROTECTIONS = new PandaBooleanField(
			"Settings.Protection.View.Show-other-player-protections", false);
	...
	public CommandResponse executeCommandProcess(CommandSender sender, PandaParameters parameters) {
		...
		if (pl != null) {
			...
			protectionParticlesService.toggleView(pl, (playerData != null && playerData.isStaffMode())
					|| SETTINGS_PROTECTION_VIEW_SHOWOTHERPLAYERPROTECTIONS.getContent());
		} else {
