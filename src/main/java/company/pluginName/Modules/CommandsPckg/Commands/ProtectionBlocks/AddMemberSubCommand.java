...
@PandaCommandAnnotation(id = "addmember", pathName = "Add-member", defaultName = "addmember", defaultDescription = "Add a member on your current protection", defaultUsage = "<username>", defaultAliases = "am")
