...
public enum MessageString implements FileObjFieldsEnum<String> {
	...
	MESSAGE_PROTECTIONS_LEFTSUCCESSFULLY("Message.Protections.Left-successfully",
			"&aYou have left the protection successfully!"),
	...
	INVENTORY_PROTECTIONBLOCKS_MANAGE_PRICENAME("Inventory.Protection-blocks.Manage.Price-name",
			"&aCurrent price: &e{block_price}"),
	INVENTORY_PROTECTIONBLOCKS_MANAGE_PRICENOTSETNAME("Inventory.Protection-blocks.Manage.Price-not-set-name",
			"&aCurrent price: &7&oNot for sale"),
	...
	ERROR_PROTECTIONS_NOTMEMBER("Error.Protections.Not-member", "&cYou're not a member of this protection!"),
	...
	ERROR_PROTECTIONS_BLOCKS_NOTFORSALE("Error.Protections.Blocks.Not-for-sale",
			"&cThis protection block is currently not for sale!"),
